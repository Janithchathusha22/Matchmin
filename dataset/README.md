...
- **Format:** 48 Teams
- **Current Stage:** Final
- **Matches Completed:** 102
- **Teams Remaining:** 2 finalists (ESP, ARG)
...
12. **`remaining_teams.csv`**: Verified title-contender list, frontend image mapping, and tournament status as of 15 July 2026.
