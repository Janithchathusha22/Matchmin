...
csv_files = {
    ...
    "remaining_teams": "remaining_teams.csv",
    "current_bracket": "current_bracket.csv",
    "remaining_team_snapshot": "remaining_team_snapshot.csv"
}
...
def build_db():
    ...
    try:
        ...
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_remaining_code ON remaining_teams(fifa_code);")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_current_bracket_match ON current_bracket(match_id);")
        conn.commit()
